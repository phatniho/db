...
<link rel="stylesheet" type="text/css" href="/css/mydb.common.css"
	media="all" />
<link rel="stylesheet" type="text/css" href="/css/mydb.commentImg.css"
	media="all" />
							...
							<div class="mc">
								<div class="tb-void tb-line">
									...
									<table class="tb-void tb-line">
										<tbody>
											<tr>
												<td><c:forEach items="${orderList }" var="orderItem">
															...
															<li class="fore1">
																<div class="p-info clearfix">
																	<div class="p-img fl">
																		...
																		<a target="_blank"
																			href="http://www.db.com/items/${ orderItem.itemId }.html">
																			<img width="50" height="50"
																			title="${orderItem.title }" data-img="1"
																			src="${orderItem.picPath }" class="err-product">
																		</a>
																	</div>
																	<div class="p-name fl">
																		<a target="_blank"
																			href="http://www.db.com/items/${orderItem.itemId }.html">${orderItem.title }</a>
																	</div>
																</div>
															</li>
															<li class="fore2"><span class="ftx03"><fmt:formatDate
																		value="${orderItem.created }"
													...
													<div class="comment-box prompt01" oid="3122336930"
														...
														<div class="form" tagflag="true" isconspros="0"
															...
															<div class="item tagEl" style="">
																...
																<div class="fl">
																	<ul class="tips-list">
																		<li vid="132"><input type="checkbox" id="che">速度快</li>
																		<li vid="128"><input type="checkbox">功能多</li>
																		<li vid="135"><input type="checkbox">使用方便</li>
																		<li vid="134"><input type="checkbox">效果不错</li>
																		<li vid="133"><input type="checkbox">功能齐全</li>
																		<li vid="129"><input type="checkbox">机器不错</li>
																		<li vid="137"><input type="checkbox">蓝牙耳机便宜</li>
																		<li class="list-last">
																			<div class="fore1">
															...
															<div class="item item01 xindeEl">
																...
																<div class="cont">
																	<!--  
                                                            <textarea name="" cols="" rows="" class="area area01" placeholder="商品是否给力？快分享你的购买心得吧~"></textarea>-->
																	<input type="text"
																		style="width: 500px; height: 80px; align: top;"
