...
function addToFavorite() {
    var a = "http://www.db.com/";
    var b = "东宝商城-网购上东宝，省钱又放心";
    if (document.all) {
		...
		<div class="mt">
			<ul class="tab">
				...
				<li class="fore hide"><a
					href="http://passport.en.db.com/user/facade">International
						Customers</a></li>
			</ul>
			<div class="extra">
				<span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
					...
					href="http://www.db.com/user/login.html" class="flk13">登录</a></span>
			</div>
		</div>
		<div class="mc">
						...
						<div class="fl item-ifo">
							<input type="checkbox" class="checkbox" checked="checked"
								...
								for="protocol">我已阅读并同意<a href="#" class="blue"
									id="protocol">《东宝用户注册协议》</a></label> <span class="clr"></span> <label
	...
	<script type="text/javascript">
    function hello() {
        var helloUrl = "http://passport.db.com/call/getHelloJson?m=ls";
	...
	<script type="text/javascript"
		src="/js/register/jdValidate.regSuccess.js"></script>
