                        ...
                        <div class="mt">
                            <ul class="extra-l">
                              <li class="fore-1"><a href="http://www.db.com/user/my-info">基本信息</a></li>
                                ...
                                <li class="fore-3"><a   class="curr"  href="http://www.db.com/user/my-info-more">更多个人信息</a></li>
