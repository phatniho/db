...
<body id="mainframe">
	...
	<form id="orderForm" class="hide">
		...
		<input type="hidden" name="orderShipping.receiverName" value="彭海" /> <input
			type="hidden" name="orderShipping.receiverMobile" value="18888888888" />
		<input type="hidden" name="orderShipping.receiverState" value="四川" />
		<input type="hidden" name="orderShipping.receiverCity" value="成都" /> <input
			type="hidden" name="orderShipping.receiverDistrict" value="锦江区" /> <input
			type="hidden" name="orderShipping.receiverAddress" value="锦江中心" />
	</form>
	<div class="w w1 header clearfix">
		<div id="logo">
			<a href="http://www.db.com/"><img src="/images/db-logo.png"
				alt="东宝商城" /></a>
		</div>
			...
			<div id="wizard" class="checkout-steps">
					...
					<div class="step-content">
						<div id="consignee" class="sbox-wrap">
							<div class="sbox">
								<div class="s-content">
									<p>
										彭海 &nbsp; 18888888888 &nbsp; &nbsp; <br /> 四川 成都市 锦江区 三环以内 &nbsp;
										锦江中心
									</p>
								</div>
							</div>
						...
						<div id="payment-ship" class="sbox-wrap">
							<div class="sbox">
								<div class="s-content payment-info">
									...
									<div class="way-list">
										<div class="way-item">
											东宝快递&nbsp;&nbsp;中小件商品&nbsp;&nbsp;<font color='#FF6600;'>工作日、双休日与假日均可送货</font>
									...
									<div class="invoice-content">
										...
										<div class="ftx-04 invoice-prompt">
											<dl class="clearfix">
												<dt>温馨提示：</dt>
												<dd>
													<div>发票的开票金额不包括东宝卡/东宝E卡、优惠券和京豆支付部分</div>
				...
				<div id="step-4" class="step step-complete">
					<div class="step-title hide">
						<a href="http://cart.db.com/cart/cart.html" id="cartRetureUrl"
															...
															<c:forEach items="${carts }" var="cart">
																<tr>
																	<td class="fore1">
																		<div class="p-goods">
																			<div class="p-img">
																				<a href="http://www.db.com/item/${cart.itemId}.html"
																			...
																			<div class="p-detail">
																				<div class="p-name">
																					<a
																						href="http://www.db.com/item/${cart.itemId}.html"
											...
											<div class="summary-form fl">
												<div class="safe-tip" style="display: none"
													...
													&nbsp;&nbsp;&nbsp;&nbsp;为保障您的账户资金安全，余额暂时不可用，请先<a
														target="_blank"
														href="http://safe.db.com/user/paymentpassword/safetyCenter.action">开启支付密码</a>
												</div>
											</div>
											<!--  预售 计算支付展现方式 begin -->
...
.checkout-buttons .checkout-submit-disabled b {
	...
	cursor: not-allowed;
								...
								<div style="display: none" id="factoryShipCodShowDivBottom"
									class="dispatching">部分商品货到付款方式：先由东宝配送“提货单”并收款，然后厂商发货。</div>
							</div>
	...
	<script type="text/javascript">
		$('#bill-tip-btn')
				.Jtips(
						{//随点随帮tip弹出
							"content" : '<a target="_blank" href="http://help.db.com/help/question-61.html#kjfpf">如何区分东宝销售和第三方卖家销售的商品?</a>',
							"close" : true,
							"position" : 'bottom'
						});
		//<![CDATA[
